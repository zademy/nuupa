...
export const MENSAJES = {
  en: {
    ...
    actualizarTodoTitulo: "Update all non-excluded outdated packages, one at a time",
    ...
    actualizarUltima: "Update to the latest version ({comando} {paquete}@latest)",
  ...
  es: {
    ...
    actualizarTodoTitulo: "Actualizar, de a uno, todos los desactualizados no excluidos",
    ...
    actualizarUltima: "Actualizar a la última versión ({comando} {paquete}@latest)",

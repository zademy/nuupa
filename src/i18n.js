...
export const MENSAJES = {
  en: {
    ...
    habilidades: "Skills",
    buscarHabilidadesTitulo: "Filter the table by skill name",
    buscarHabilidadPlaceholder: "Search skills…",
    columnaHabilidad: "skill",
    columnaEstado: "state",
    captionTablaHabilidades: "Agent skills, at user level",
    refrescarHabilidades: "Refresh: scan the skills folder again",
    habilidad: "skill",
    invalida: "invalid",
    invalidas: "invalid",
    estadoNoGestionada: "not managed",
    ...
    sinHabilidades:
      "no skills in the folder yet — add yours from a repository URL",
    cargandoHabilidades: "scanning the skills folder…",
    habilidadesCorruptas:
  ...
  es: {
    ...
    buscarHabilidadesTitulo: "Filtrar la tabla por nombre de habilidad",
    buscarHabilidadPlaceholder: "Buscar habilidad…",
    columnaHabilidad: "habilidad",
    columnaEstado: "estado",
    captionTablaHabilidades: "Habilidades de agentes, a nivel de usuario",
    refrescarHabilidades:
      "Refrescar: volver a escanear la carpeta de habilidades",
    habilidad: "habilidad",
    invalida: "inválida",
    invalidas: "inválidas",
    estadoNoGestionada: "No gestionada",
    ...
    sinHabilidades:
      "sin habilidades en la carpeta todavía — agrega las tuyas desde la URL de un repositorio",
    cargandoHabilidades: "escaneando la carpeta de habilidades…",
    habilidadesCorruptas:
